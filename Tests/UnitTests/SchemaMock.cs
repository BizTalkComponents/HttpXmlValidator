...
namespace BizTalkComponents.HttpXmlValidator.Tests.UnitTests
{
    ...
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::BizTalkComponents.HttpXmlValidator.Tests.UnitTests.TestProperty1), XPath = @"/*[local-name()='TestSchema' and namespace-uri()='http://BiztalkComponents.TestSchema']/*[local-name()='TestElement1' and namespace-uri()='']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::BizTalkComponents.HttpXmlValidator.Tests.UnitTests.TestProperty2), XPath = @"/*[local-name()='TestSchema' and namespace-uri()='http://BiztalkComponents.TestSchema']/*[local-name()='TestElement2' and namespace-uri()='']", XsdType = @"string")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] { @"TestSchema" })]
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"BizTalkComponents.HttpDisassembler.Tests.UnitTests.PropertySchema", typeof(global::BizTalkComponents.HttpXmlValidator.Tests.UnitTests.PropertySchema))]
